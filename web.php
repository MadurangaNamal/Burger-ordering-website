...
<body>
 ...
 <article>
				...
				<div id="Box">
                    ...
                    <input type="text" name="quantity" placeholder="1" style="background-color:chartreuse; color:darkred; width: 30%; padding: 0; margin: 0; border: none; text-align: center;">
             ...
             <div id="Box">
                   ...
                   <form action="cart.php" method="POST">
                        <h6>Enter quantity below :</h6>
                <input type="text" name="quantity" placeholder="1" style="background-color:chartreuse; color:darkred; width: 30%; padding: 1px; margin: 0; border: none; text-align: center;">
